...
var GeoTemporalSet  = require('../common/geotemporalset');
var LatLon          = require('../common/latlon');
...
function StreamClusterer(json) {
  ...
  // Only cluster once a second
  var t = setInterval(this.cluster.bind(this), 1000);
